...
_ = Translator("OverkillAlert", __file__)
...
class OverkillAlert(
    ...
    async def overkillalert(self, ctx: commands.Context) -> None:
        """Set notifications for all adventures"""
        pass

    @overkillalert.command()
    async def removeall(self, ctx: commands.Context) -> None:
        """Remove all overkillalert settings in all guilds"""
    ...
    async def removealluser(self, ctx: commands.Context, user_id: int) -> None:
        """Remove A specified user from overkillalert across the bot"""
    ...
    @overkillalert.command(name="settings", aliases=["setting"])
    ...
    @overkillalert.command(name="role", aliases=["roles"])
    ...
    @commands.guild_only()
    @overkillalert.command(name="toggle", aliases=["user", "users", "remove", "rem", "add"])
    ...
    @overkillalert.command(name="global")
    ...
    @overkillalert.command(name="removeuser")
